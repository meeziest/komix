      ...
      switch (widget.scrollDirection) {
        ...
        case Axis.vertical:
          if (widget.reverse) {
            ...
            listPadding = EdgeInsets.fromLTRB(padding.left, widget.footer != null ? 0 : padding.top,
                padding.right, widget.header != null ? 0 : padding.bottom);
            ...
            listPadding = EdgeInsets.fromLTRB(padding.left, widget.header != null ? 0 : padding.top,
                padding.right, widget.footer != null ? 0 : padding.bottom);
